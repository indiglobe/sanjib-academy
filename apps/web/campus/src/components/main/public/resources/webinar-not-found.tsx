  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          No webinars available right now
        </h1>

        {/* Description */}
        <p className={cn(`text-foreground/70 max-w-lg text-sm sm:text-base`)}>
          The webinars you're looking for may not exists or are currently
        ...
        <p className={cn(`text-foreground/50 pt-4 text-xs`)}>
          New webinars are added regularly. Check back soon.
        </p>
      </div>
    </section>
  );
